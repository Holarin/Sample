...
public class ArrowComp extends AbstractProductArrow implements Cloneable {
    double arrowHeadSize;// размер кончика стрелки

    public ArrowComp(double x, double y, double w, double h) {
    ...
    public void drawArrowend(GraphicsContext gc) {
        ...
        gc.moveTo(x2, y2);
        gc.lineTo(endX, endY);
        Rectangle rectangle = new Rectangle(endX, endY, 10, 10);
        rectangle.setFill(Color.BLACK);
        gc.fillRect(endX, endY, 10, 10);
    }
