...
public class ArrowInherit extends AbstractProductArrow implements Cloneable {
    double arrowHeadSize;// размер кончика стрелки

    public ArrowInherit(double x, double y, double w, double h) {
